...
app.get('/', (req, res) => {
  res.json({
    message: 'Restaurant Reservation System API - Student ID: 1771020304',
    version: '2.0.0',
    database: 'db_exam_1771020304',
    endpoints: {
...
app.listen(PORT, () => {
  ...
  console.log(`💾 Database: db_exam_1771020304`);
  console.log(`👤 Student ID: 1771020304`);
});